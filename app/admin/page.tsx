// app/admin/page.tsx
// The middleware already enforces server-side auth + admin role check for /admin/*.
// This page does NOT need to re-verify auth client-side — that was redundant and
// exposed the page structure while the client-side check was pending.
'use client';
